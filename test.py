...
def test(args):
    ...
    loader = data_loader(root=ROOT/'gradset', is_transform=True, img_norm=args.img_norm, test_mode=True)

    #changed from     n_classes = loader.n_classes
    n_classes = loader.n_classes - 2
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default=ROOT/'runs/frrnB_cityscapes/bestGrad/frrnB_cityscapes_best_model.pkl',
    ...
    parser.add_argument(
        "--img_path", nargs="?", type=str, default=ROOT/'testImgs/img_0_1588702706526701900.png', help="Path of the input image"
    )
    parser.add_argument(
        "--out_path", nargs="?", type=str, default=ROOT/'testImgs/out/img_0_1588702706526701900_pred.png', help="Path of the output segmap predition"
    )
